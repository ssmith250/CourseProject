...
#
#  heroku config:set DJANGO_SECRET_KEY='ck!dw-a%h5@+i5tnp@xjnk569#gri9#lfow^$uuh60bluz0gn6'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = 'ck!dw-a%h5@+i5tnp@xjnk569#gri9#lfow^$uuh60bluz0gn6'
...
# if the environment variable is not defined then default to CourseProject_db.sqlite3.
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///"+os.path.join(BASE_DIR, 'CourseProject_db.sqlite3')),
}
